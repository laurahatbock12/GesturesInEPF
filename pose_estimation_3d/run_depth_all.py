...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run Depth Anything 3 monocular depth estimation for every participant "
        "recording and every reference video."
    )
    parser.add_argument(
        "--project_folder",
        type=Path,
    ...
    parser.add_argument("--model_name", type=str, default="depth-anything/DA3METRIC-LARGE")
...
def main(args):
    ...
    depth_script = script_folder / "estimate_monocular_depth.py"
